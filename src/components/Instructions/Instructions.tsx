...
export default function Instructions({onClose}: IInstructions) {
    ...
    return (
        <div ref={ref} className="Instructions">
            ...
            <p>When two tiles of the same value are next to each other in the direction the board moves they merge into
                one.</p>
            <p>The aim of the game is to reach 2048. If there are no empty tiles left and no directions to move so your
                tiles merged it's game over!</p>
        </div>
    )
}
